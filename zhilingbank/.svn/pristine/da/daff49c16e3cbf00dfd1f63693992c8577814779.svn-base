...
<html>
		...
		<script src="https://cdn.bootcss.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
	  	...
	  	<script type="text/javascript">
	  		function openWin() { 
	           ...
	           window.open('opencard.jsp', name, 'height=' + iHeight + ',,innerHeight=' + iHeight + ',width=' + iWidth + ',innerWidth=' + iWidth + ',top=' + iTop + ',left=' + iLeft + ',status=no,toolbar=no,menubar=no,location=no,resizable=no,scrollbars=0,titlebar=no'); 
	  		...
	  		function openwin() { 
	           ...
	           //获得窗口的水平位置 
	           var iLeft = (window.screen.availWidth - 10 - iWidth) / 2; 
	           window.open('jindu.jsp', name, 'height=' + iHeight + ',,innerHeight=' + iHeight + ',width=' + iWidth + ',innerWidth=' + iWidth + ',top=' + iTop + ',left=' + iLeft + ',status=no,toolbar=no,menubar=no,location=no,resizable=no,scrollbars=0,titlebar=no'); 
	          // window.open("AddScfj.aspx", "newWindows", 'height=100,width=400,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no'); 
      		 }
	  	</script>
  ...
  <body>
  	<div align="center">
		...
		<script type="text/javascript">
			$("#yemian").load("main.jsp");
			$("#main").click(function(){
				$("#yemian").load("main.jsp");
			});
			$("#huaikuan").click(function(){
				$("#yemian").load("huaikuan.jsp");
			});
			$("#login").click(function(){
				$("#yemian").load("login.jsp");
			});
			$("#recommend").click(function(){
				$("#yemian").load("recommend.jsp");
			});
			$("#bankmessage").click(function(){
				$("#yemian").load("bankmessage.jsp");
			});
