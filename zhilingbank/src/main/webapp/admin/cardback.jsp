...
<script type="text/javascript">
  			...
  			$("#comitInfo").click(function(){
  				verifyCode();
  				var r=confirm("确认已找回信用卡？")
  			    if (r && doveryfi){
  			    	$.ajax({
						data:{"cardNum":$("#cardNumInput").val(), "cardStatus":"1", "cardstatus":"2"},	  	  					
  	  					type:"post",
  	  					dataType:"json",
  	  					url:"card/cardLoss",
  	  					success:function(data){
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="authCodeInput"
					placeholder="请输入验证码"> <font id="authCodeHint" color="red"></font>
			</div>
		</div>
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10" style="width: 520px;">
				<input type="submit" class="btn btn-warning"
					style="width: 150px; margin-left: -150px;" value="解除挂失"
					id="comitInfo" />
			</div>
		</div>
	</div>
