...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
  <tr>
    ...
    <span class="time"><strong>上午好！${loginemp.account }</strong>
   	<u>${loginemp.pos.pname }</u>    
    </span>
    <div class="top"><span class="left">您上次的登灵时间：${ereco.logintime }   登录IP：127.0.0.1 &nbsp;&nbsp;&nbsp;&nbsp;如非您本人操作，请及时</span><a href="index.html" target="mainFrame" onFocus="this.blur()">更改密码</a></div>
    <div class="sec">这是您第<span class="num">${to }</span>次,登录！</div>
    </td>
  </tr>
  <tr>
